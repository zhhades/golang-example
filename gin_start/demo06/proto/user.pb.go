...
type Teacher struct {
	...
	Cause []string `protobuf:"bytes,2,rep,name=cause,proto3" json:"cause,omitempty"`
}
...
func (x *Teacher) GetCause() []string {
	if x != nil {
		return x.Cause
	}
	return nil
...
var file_user_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x33, 0x0a, 0x07,
	...
	0x61, 0x75, 0x73, 0x65, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x63, 0x61, 0x75, 0x73,
